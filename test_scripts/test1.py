...
# hover pe bacanie
driver.find_element(By.XPATH, '//div[contains(@class,"cookie-banner-buttons")]/button[contains(text(), "Accept")]').click()
...
driver.find_element(By.XPATH, "/html/body/div[11]/div/button/i").click()
sleep(3)
...
# observati ca pornim de la nume produsdiv[contains(@class,"em em-close")
